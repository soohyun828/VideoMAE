...
echo "";echo "";
####################################################################################################################################
ORIGINAL_SH=/data/jong980812/project/VideoMAE/scripts/internvid_k400.sh
DIR=/data/jong980812/project/VideoMAE/result/internvid_k100
...
NODE_LIST["moana-y5"]=2;        orders+=( "moana-y5" )
NODE_LIST["moana-y6"]=;        orders+=( "moana-y6" )
